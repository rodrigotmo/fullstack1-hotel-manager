...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='quarto',
            name='status_quarto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.statusquarto'),
        ),
        migrations.CreateModel(
            name='Reserva',
            fields=[
                ...
                ('quarto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.quarto')),
                ('status_reserva', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.statusreserva')),
                ('tarifa_tipo_quarto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.tarifatipoquarto')),
            ],
        ),
        migrations.AddField(
            model_name='tarifatipoquarto',
            name='tipo_quarto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='principal.tipoquarto'),
        ),
        migrations.AddField(
            model_name='quarto',
            name='tipo_quarto',
